...
struct InputParameters {
    ...
    std::string dendrogramOutputFile; // name of the file where the dendrogram arrangement should be saved
    ...
    {
        ar& fileName& shortName& outputFile& dendrogramOutputFile& dim& x_bins& y_bins& verbosity& x_label& y_label& outputFormat;
    }
};
